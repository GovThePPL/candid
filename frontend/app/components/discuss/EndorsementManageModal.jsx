 ...
 * Shows the user's endorsed proposals with remove buttons.
 ...
 */
export default function EndorsementManageModal({ visible, onClose, endorsedPosts, onRemove, pendingPostTitle }) {
      ...
      <View style={styles.list}>
        ...
        {endorsedPosts?.map((ep) => (
          <View key={ep.id} style={styles.row}>
            ...
            <ThemedText variant="body" numberOfLines={2} style={styles.proposalTitle}>
              {ep.title}
            </ThemedText>
            <TouchableOpacity
              ...
              accessibilityLabel={`${t('endorsementManageRemove')}: ${ep.title}`}
